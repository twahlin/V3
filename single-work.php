      ...
      function nerdy_get_images($size = 'thumbnail', $limit = '0', $offset = '0') {
          ...
          if ($images) {
              ...
              foreach ($images as $image) {
                  ...
                  ?>
                  <li>
                    <img src="<?php bloginfo('template_directory'); ?>/scripts/php/timthumb/timthumb.php?src=<?php echo $img_preview ?>&w=850&s=1" alt="<?php echo $img_caption; ?>" title="<?php echo $img_caption; ?>">
                  </li>
                  <?
                  }
                  $i++;
