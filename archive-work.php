...
<div id="masonry_responsive_grid" class="masonry_responsive_grid">
    ...
    <div class="masonry_item"><a class="img_border" href="#"><div class="img_wrap"><em>Here is the image title</em><img src="<?php bloginfo('template_directory'); ?>/images/tmp/fpo_800.png" style="height: 150px" /></div></a></div>  
